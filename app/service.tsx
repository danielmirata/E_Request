        ...
        <View style={styles.container}>
          <View style={styles.logoContainer}>
            <Image 
              ...
              resizeMode="contain" 
            />
            <Text style={styles.title}>Cantil E e-Request</Text>
            <Text style={styles.subtitle}>Welcome to Barangay e-Request</Text>
          </View>
          
          <View style={styles.buttonContainer}>
            <Link href="/request" asChild>
              <TouchableOpacity style={styles.primaryButton}>
                <Text style={styles.primaryButtonText}>Request Barangay Docs</Text>
              </TouchableOpacity>
            </Link>
            
            <Link href="/complain" asChild>
              <TouchableOpacity style={styles.secondaryButton}>
                <Text style={styles.secondaryButtonText}>Send Complain</Text>
              </TouchableOpacity>
            </Link>
          </View>
